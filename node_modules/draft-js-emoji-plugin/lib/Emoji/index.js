...
var Emoji = function Emoji(_ref) {
  ...
  var theme = _ref$theme === undefined ? (0, _immutable.Map)() : _ref$theme;
  var className = _ref.className;
  var decoratedText = _ref.decoratedText;

  var props = _objectWithoutProperties(_ref, ['theme', 'className', 'decoratedText']);

  var unicode = _escapeMap2.default[decoratedText];
  var imagePath = 'url(' + imagePathSVG + unicode + '.svg' + cacheBustParam + ')';
  var combinedClassName = (0, _unionClassNames2.default)(theme.get('emoji'), className);
