...
var InstantSearch = function (_EventEmitter) {
  ...
  function InstantSearch(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InstantSearch).call(this));
    ...
    var client = (0, _lite2.default)(appId, apiKey);
  ...
  _createClass(InstantSearch, [{
    ...
    value: function _init(state, helper) {
      var _onHistoryChange = this._onHistoryChange;
...
function enhanceConfiguration(configuration, widgetDefinition) {
  ...
  return (0, _merge2.default)({}, configuration, partialConfiguration, function (a, b) {
    if (Array.isArray(a)) {
